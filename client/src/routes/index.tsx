...
type Filter = "all" | "complexion" | "color" | "body" | "age";
            ...
            {COLLECTIONS.map((c) => (
              ...
              >
                ...
                <div className="text-[10px] uppercase tracking-widest text-muted-foreground mt-1">
                  {c.sub} · {products.filter(c.filter).length} items
                </div>
              </button>
            ))}
          </div>

          <div id="catalogue" className="flex gap-2 overflow-x-auto pb-4 no-scrollbar mb-8 -mx-4 md:mx-0 px-4 md:px-0">
            {FILTERS.map((f) => {
